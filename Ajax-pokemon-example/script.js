...
document.getElementById("searchPokemon").addEventListener("click", async (event) => {
    ...
    try {
        ...
        const body = document.body;
        body.innerHTML += `<p>${userInput.value} is not a valid pokemon name, please try again.</p>`
    }
});
