$(document).ready(function () {
    ...
    const categoryImages = {
      ...
      cities: [
        { alt: "Skyline", src: "./images/skyline.jpg" },
        { alt: "Street Car", src: "./images/streetcar.jpg" },
        { alt: "Highway", src: "./images/highway.jpg" },
      ],
      forests: [
        { alt: "Mossy Rock", src: "mountain1.jpg" },
        { alt: "Shimmering River", src: "mountain2.jpg" },
        { alt: "Tree Canopy", src: "mountain3.jpg" },
      ],
      deserts: [
        { alt: "Sandy Slopes", src: "./images/sandy.jpg" },
        { alt: "Camel Riding", src: "./images/camel.jpg" },
    ...
    //  if ($("#cities-carousel").hasClass("active"))
    //    {
    //      $("#footer").html("<p>Blurb</p>");
    //    }
    // }
    // Couldn't figure out how to display it for only the one that's active unfortunately.

    $("#footer").html("<p>The Skyline picture is my favourite. It's a beautiful representation of how far society has come. The water, buildings, sky and the bridge all come together harmoniously to make a stunning cityscape.</p>");
